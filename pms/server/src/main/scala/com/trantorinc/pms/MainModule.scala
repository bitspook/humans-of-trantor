...
import com.trantorinc.pms.employee.EmployeeModule
...
/**
  ...
  */
trait MainModule extends StandupModule with EmployeeModule with MetricsModule with InfrastructureModule {
  ...
  private lazy val endpoints: ServerEndpoints = standupApi.endpoints concatNel employeeApi.endpoints
